	...
	\bookpart {
		\markup {
			\column {
				...
				\fill-line { \small "Git describe: 177-79-gccbc96a3" }
				\fill-line { \small "Git commits: 1912" }
				\fill-line { \small "Build date: 08:46:28 19-09-2024" }
...
\tocItem \markup "These Foolish Things / "
...
\markup {
	\column {
		...
		\column {
			\huge \larger \bold
			\fill-line { \larger "These Foolish Things" }
			\fill-line {
				""
				"Lyrics and Music by "
			}
