...
<html>
	...
	<body>
		...
		<p>Links to tools used by the <b>${config.project.project_name}</b> project:</p>
		<ul>
			<li>
			The git tool used as a source control system for <b>${config.project.project_name}</b> is <a title="git" href="http://git-scm.com/">here</a>
			</li>
			<li>
			The GNU make system used to build <b>${config.project.project_name}</b> is <a title="GNU make" href="http://www.gnu.org/s/make/">here</a>
			</li>
			<li>
			The python scripting language that is used to script <b>${config.project.project_name}</b> is <a title="python" href="http://python.org/">here</a>
			</li>
			<li>
			The mako templating engine for python that is used in <b>${config.project.project_name}</b> is <a title="mako" href="http://www.makotemplates.org/">here</a>
			</li>
			<li>
			The lilypond language and compiler used to develop the tunes in <b>${config.project.project_name}</b> is <a title="lilypond" href="http://lilypond.org/">here</a>
			</li>
			<li>
			The timidity tool used to convert from midi to wav and ogg in <b>${config.project.project_name}</b> is <a title="timidity++" href="http://timidity.sourceforge.net/">here</a>
			</li>
			<li>
			The lame tool used to encode midi to mp3 in <b>${config.project.project_name}</b> is <a title="lame" href="http://lame.sourceforge.net/">here</a>
			</li>
		</ul>
